...
DatabaseCases.forEach((db) => {
    ...
    describe(db.constructor["name"], () => {
        ...
        it('should get item and collection', done => {
            var orgUser: OrgUser = stores.OrgUserStore.getbyId('dunder-mifflin', "google-Jk0wcm5svSaBAU6Doh5UlPqBrZj1:0", "admin");
            var callbackno: number = 0;
            var r1: IReactionDisposer;

            reaction(function () { return { 0: orgUser.item_value, 1: orgUser.org.roles, 2: orgUser.org.name, 3: toJS(orgUser.org.orgUsers), 4: orgUser.loading, 5: orgUser.org.orgUsers["loading"].value }; },
                (_, r) => {
                    callbackno++;
        ...
        it('should create record', done => {
            var orgUser = stores.OrgUserStore.getbyId('dunder-mifflin', "google-Jk0wcm5svSaBAU6Doh5UlPqBrZj1:0", "admin");
                ...
                (_, r) => {
                    ...
                    switch (callbackno) {
                        ...
                        case 4:
                            ...
                            var users = toJS(orgUser.org.orgUsers);
                            expect(users.length).toBe(3);
                            var item = push(orgUser.org.orgUsers as IEnhancedObservableArray<OrgUser>);
                            r1 = autorun(() =>
                                item.user_id);
                            setTimeout(action(() => {
                                item.user_id = "us-east-1:d000000e-0000-0000-0000-00000000000";
                                item.role_id = enums.EnumConfigRole.consumer;
        ...
        it('should delete previously created record', done => {
            ...
            reaction(function () { return { 0: orgUser.item_value, 1: orgUser.org.roles, 2: orgUser.org.name, 3: toJS(orgUser.org.orgUsers), 6: orgUser.org.orgUsers.length, 4: orgUser.loading, 5: orgUser.org.orgUsers["loading"].value }; },
                (_, r) => {
                    callbackno++;
                    ...
                    switch (callbackno) {
                        ...
                        case 2:
                            ...
                            var item = stores.OrgUserStore.getbyId('dunder-mifflin', "us-east-1:d000000e-0000-0000-0000-00000000000", "consumer");
        ...
        it('should update record', done => {
            ...
            var _ = reaction(function () { return { 0: orgUser.item_value, 1: orgUser.org.roles, 2: orgUser.org.name, 3: toJS(orgUser.org.orgUsers), 4: orgUser.loading, 5: orgUser.org.orgUsers["loading"].value }; },
                (_, r) => {
                    callbackno++;
                    ...
                    switch (callbackno) {
                        ...
                        case 4:
                            ...
                            setTimeout(() => autorun((r1) => {
                                ++statuscallbackno;
                                var _ = { 0: orgUser.org.name, 1: orgUser.org.status.executing };
